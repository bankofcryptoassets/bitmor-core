...
async function main() {
  ...
  // Step 3: Crash price to trigger full liquidation (keep 70% of value = 30% drop)
  console.log("Step 3: Crashing cbBTC price by 30% (keeping 70% of value)...");
  const newPrice = currentPrice.mul(70).div(100); // Keep 70% of value
  ...
  // Step 7: Execute full liquidation
  console.log("Step 7: Executing full liquidation...");
  const liquidationTx = await lendingPool.liquidationCall(
    CBBTC_ADDRESS,
    USDC_ADDRESS,
    LSA_ADDRESS,
    debtAmountUSDC,
