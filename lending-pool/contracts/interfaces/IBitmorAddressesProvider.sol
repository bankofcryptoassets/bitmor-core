 ...
 * Security: see https://bitmor.com/security
 */
interface IBitmorAddressesProvider {
     ...
     */
    event BitmorAddressesProvider__LiquidationFeeCollectorUpdated(
        address indexed liquidationFeeCollector
    );
     ...
     * @dev Access: Restricted via AccessManaged
     */
