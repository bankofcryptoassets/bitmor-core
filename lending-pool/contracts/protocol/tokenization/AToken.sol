 ...
 *
 * Bitmor accounting invariant (8.1 - Global USDC Conservation):
 * aToken.totalSupply() MUST equal variableDebtToken.totalSupply()
 * + total_idle_USDC (IERC20(usdc).balanceOf(aTokenAddress) + aUSDC held by USDCStrategy)
 * + protocol_revenue_accrued.
 * @author Aave
 */
