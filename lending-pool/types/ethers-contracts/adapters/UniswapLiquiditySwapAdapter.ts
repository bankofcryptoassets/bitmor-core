...
export declare namespace IBaseUniswapAdapter {
  ...
  export interface UniswapLiquiditySwapAdapterInterface extends Interface {
    getFunction(nameOrSignature: "ADDRESSES_PROVIDER" | "FLASHLOAN_PREMIUM_TOTAL" | "LENDING_POOL" | "MAX_SLIPPAGE_PERCENT" | "ORACLE" | "UNISWAP_ROUTER" | "USD_ADDRESS" | "WETH_ADDRESS" | "executeOperation" | "getAmountsIn" | "getAmountsOut" | "owner" | "renounceOwnership" | "rescueTokens" | "swapAndDeposit" | "transferOwnership"): FunctionFragment;
...
encodeFunctionData(functionFragment: 'swapAndDeposit', values: [AddressLike[], AddressLike[], BigNumberish[], BigNumberish[], IBaseUniswapAdapter.PermitSignatureStruct[], boolean[]]): string;
...
decodeFunctionResult(functionFragment: 'transferOwnership', data: BytesLike): Result;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    swapAndDeposit: TypedContractMethod<
      [assetToSwapFromList: AddressLike[], assetToSwapToList: AddressLike[], amountToSwapList: BigNumberish[], minAmountsToReceive: BigNumberish[], permitParams: IBaseUniswapAdapter.PermitSignatureStruct[], useEthPath: boolean[], ],
      [void],
      'nonpayable'
    >
