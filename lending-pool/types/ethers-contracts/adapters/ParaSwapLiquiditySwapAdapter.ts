...
export declare namespace BaseParaSwapAdapter {
  ...
  export interface ParaSwapLiquiditySwapAdapterInterface extends Interface {
    getFunction(nameOrSignature: "ADDRESSES_PROVIDER" | "AUGUSTUS_REGISTRY" | "LENDING_POOL" | "MAX_SLIPPAGE_PERCENT" | "ORACLE" | "executeOperation" | "owner" | "renounceOwnership" | "rescueTokens" | "swapAndDeposit" | "transferOwnership"): FunctionFragment;
...
encodeFunctionData(functionFragment: 'swapAndDeposit', values: [AddressLike, AddressLike, BigNumberish, BigNumberish, BigNumberish, BytesLike, AddressLike, BaseParaSwapAdapter.PermitSignatureStruct]): string;
...
decodeFunctionResult(functionFragment: 'transferOwnership', data: BytesLike): Result;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    AUGUSTUS_REGISTRY: TypedContractMethod<
      [],
      [string],
      'view'
    >
    ...
    swapAndDeposit: TypedContractMethod<
      [assetToSwapFrom: AddressLike, assetToSwapTo: AddressLike, amountToSwap: BigNumberish, minAmountToReceive: BigNumberish, swapAllBalanceOffset: BigNumberish, swapCalldata: BytesLike, augustus: AddressLike, permitParams: BaseParaSwapAdapter.PermitSignatureStruct, ],
      [void],
      'nonpayable'
    >
    ...
    getFunction(nameOrSignature: 'ADDRESSES_PROVIDER'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'AUGUSTUS_REGISTRY'): TypedContractMethod<
      [],
      [string],
      'view'
    >;
