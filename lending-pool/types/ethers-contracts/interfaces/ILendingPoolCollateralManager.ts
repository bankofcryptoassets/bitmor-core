...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../common.js"
  ...
  export interface ILendingPoolCollateralManagerInterface extends Interface {
...
decodeFunctionResult(functionFragment: 'microLiquidationCall', data: BytesLike): Result;
    ...
    export namespace LiquidationCallEvent {
      ...
      export interface OutputObject {collateral: string, principal: string, user: string, debtToCover: bigint, liquidatedCollateralAmount: bigint, liquidator: string, receiveAToken: boolean };
  ...
  export interface ILendingPoolCollateralManager extends BaseContract {
    ...
    connect(runner?: ContractRunner | null): ILendingPoolCollateralManager;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    liquidationCall: TypedContractMethod<
      [collateral: AddressLike, principal: AddressLike, user: AddressLike, debtToCover: BigNumberish, receiveAToken: boolean, ],
      [[bigint, string]],
      'nonpayable'
    >
