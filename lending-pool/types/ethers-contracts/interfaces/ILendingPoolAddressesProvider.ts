...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../common.js"
  ...
  export interface ILendingPoolAddressesProviderInterface extends Interface {
    getFunction(nameOrSignature: "getAddress" | "getBitmorLoan" | "getEmergencyAdmin" | "getLendingPool" | "getLendingPoolCollateralManager" | "getLendingPoolConfigurator" | "getLendingRateOracle" | "getMarketId" | "getPoolAdmin" | "getPriceOracle" | "getUSDCVault" | "setAddress" | "setAddressAsProxy" | "setBitmorLoan" | "setEmergencyAdmin" | "setLendingPoolCollateralManager" | "setLendingPoolConfiguratorImpl" | "setLendingPoolImpl" | "setLendingRateOracle" | "setMarketId" | "setPoolAdmin" | "setPriceOracle" | "setUSDCVault"): FunctionFragment;

    getEvent(nameOrSignatureOrTopic: "AddressSet" | "BitmorLoanUpdated" | "ConfigurationAdminUpdated" | "EmergencyAdminUpdated" | "LendingPoolCollateralManagerUpdated" | "LendingPoolConfiguratorUpdated" | "LendingPoolUpdated" | "LendingRateOracleUpdated" | "MarketIdSet" | "PriceOracleUpdated" | "ProxyCreated" | "USDCVaultUpdated"): EventFragment;
...
decodeFunctionResult(functionFragment: 'setUSDCVault', data: BytesLike): Result;
    ...
    export namespace BitmorLoanUpdatedEvent {
      export type InputTuple = [bitmorLoan: AddressLike];
      export type OutputTuple = [bitmorLoan: string];
      export interface OutputObject {bitmorLoan: string };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
    ...
    export namespace MarketIdSetEvent {
      ...
      export interface OutputObject {newMarketId: string };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
    ...
    export namespace ProxyCreatedEvent {
      ...
      export interface OutputObject {id: string, newAddress: string };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    getEmergencyAdmin: TypedContractMethod<
      [],
      [string],
      'view'
    >
    ...
    getLendingPool: TypedContractMethod<
      [],
      [string],
      'view'
    >
    ...
    getLendingPoolConfigurator: TypedContractMethod<
      [],
      [string],
      'view'
    >
    ...
    getLendingRateOracle: TypedContractMethod<
      [],
      [string],
      'view'
    >
    ...
    getPoolAdmin: TypedContractMethod<
      [],
      [string],
      'view'
    >
    ...
    setPoolAdmin: TypedContractMethod<
      [admin: AddressLike, ],
      [void],
      'nonpayable'
    >
...
getFunction(nameOrSignature: 'getBitmorLoan'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'getEmergencyAdmin'): TypedContractMethod<
      [],
      [string],
      'view'
    >;
getFunction(nameOrSignature: 'getLendingPool'): TypedContractMethod<
      [],
      [string],
      'view'
    >;
getFunction(nameOrSignature: 'getLendingPoolCollateralManager'): TypedContractMethod<
      [],
      [string],
      'view'
    >;
getFunction(nameOrSignature: 'getLendingPoolConfigurator'): TypedContractMethod<
      [],
      [string],
      'view'
    >;
getFunction(nameOrSignature: 'getLendingRateOracle'): TypedContractMethod<
      [],
      [string],
      'view'
    >;
getFunction(nameOrSignature: 'getMarketId'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'getPoolAdmin'): TypedContractMethod<
      [],
      [string],
      'view'
    >;
...
getFunction(nameOrSignature: 'setBitmorLoan'): TypedContractMethod<
      ...
      'nonpayable'
    >;
getFunction(nameOrSignature: 'setEmergencyAdmin'): TypedContractMethod<
      [admin: AddressLike, ],
      [void],
      'nonpayable'
    >;
getFunction(nameOrSignature: 'setLendingPoolCollateralManager'): TypedContractMethod<
      [manager: AddressLike, ],
      [void],
      'nonpayable'
    >;
getFunction(nameOrSignature: 'setLendingPoolConfiguratorImpl'): TypedContractMethod<
      [configurator: AddressLike, ],
      [void],
      'nonpayable'
    >;
getFunction(nameOrSignature: 'setLendingPoolImpl'): TypedContractMethod<
      [pool: AddressLike, ],
      [void],
      'nonpayable'
    >;
...
getFunction(nameOrSignature: 'setMarketId'): TypedContractMethod<
      ...
      'nonpayable'
    >;
getFunction(nameOrSignature: 'setPoolAdmin'): TypedContractMethod<
      [admin: AddressLike, ],
      [void],
      'nonpayable'
    >;
...
getEvent(key: 'USDCVaultUpdated'): TypedContractEvent<USDCVaultUpdatedEvent.InputTuple, USDCVaultUpdatedEvent.OutputTuple, USDCVaultUpdatedEvent.OutputObject>;
    ...
    filters: {
      ...
      BitmorLoanUpdated: TypedContractEvent<BitmorLoanUpdatedEvent.InputTuple, BitmorLoanUpdatedEvent.OutputTuple, BitmorLoanUpdatedEvent.OutputObject>;
