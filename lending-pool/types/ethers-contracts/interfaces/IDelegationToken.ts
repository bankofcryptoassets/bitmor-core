...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../common.js"
  ...
  export interface IDelegationTokenInterface extends Interface {
    getFunction(nameOrSignature: "delegate"): FunctionFragment;
  ...
  export interface IDelegationToken extends BaseContract {
    ...
    connect(runner?: ContractRunner | null): IDelegationToken;
