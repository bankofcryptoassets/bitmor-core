...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../../../common.js"
  ...
  export interface InitializableAdminUpgradeabilityProxyInterface extends Interface {
    getFunction(nameOrSignature: "admin" | "changeAdmin" | "implementation" | "initialize(address,address,bytes)" | "initialize(address,bytes)" | "upgradeTo" | "upgradeToAndCall"): FunctionFragment;
...
encodeFunctionData(functionFragment: 'initialize(address,address,bytes)', values: [AddressLike, AddressLike, BytesLike]): string;
encodeFunctionData(functionFragment: 'initialize(address,bytes)', values: [AddressLike, BytesLike]): string;
...
decodeFunctionResult(functionFragment: 'upgradeToAndCall', data: BytesLike): Result;
  ...
  export interface InitializableAdminUpgradeabilityProxy extends BaseContract {
    ...
    connect(runner?: ContractRunner | null): InitializableAdminUpgradeabilityProxy;
...
getFunction(nameOrSignature: 'implementation'): TypedContractMethod<
      ...
      'nonpayable'
    >;
getFunction(nameOrSignature: 'initialize(address,address,bytes)'): TypedContractMethod<
      [logic: AddressLike, admin: AddressLike, data: BytesLike, ],
      [void],
      'payable'
    >;
getFunction(nameOrSignature: 'initialize(address,bytes)'): TypedContractMethod<
      [_logic: AddressLike, _data: BytesLike, ],
      [void],
      'payable'
    >;
