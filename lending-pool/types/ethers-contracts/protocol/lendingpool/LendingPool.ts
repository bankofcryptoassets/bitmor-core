...
decodeFunctionResult(functionFragment: 'withdraw', data: BytesLike): Result;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    LENDINGPOOL_REVISION: TypedContractMethod<
      [],
      [bigint],
      'view'
    >
    ...
    finalizeTransfer: TypedContractMethod<
      [asset: AddressLike, from: AddressLike, to: AddressLike, amount: BigNumberish, balanceFromBefore: BigNumberish, balanceToBefore: BigNumberish, ],
      [void],
      'nonpayable'
    >
    ...
    initReserve: TypedContractMethod<
      [asset: AddressLike, aTokenAddress: AddressLike, stableDebtAddress: AddressLike, variableDebtAddress: AddressLike, interestRateStrategyAddress: AddressLike, ],
      [void],
      'nonpayable'
    >
    ...
    getFunction(nameOrSignature: 'FLASHLOAN_PREMIUM_TOTAL'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'LENDINGPOOL_REVISION'): TypedContractMethod<
      [],
      [bigint],
      'view'
    >;
getFunction(nameOrSignature: 'MAX_NUMBER_RESERVES'): TypedContractMethod<
      [],
      [bigint],
      'view'
    >;
getFunction(nameOrSignature: 'MAX_STABLE_RATE_BORROW_SIZE_PERCENT'): TypedContractMethod<
      [],
      [bigint],
      'view'
    >;
