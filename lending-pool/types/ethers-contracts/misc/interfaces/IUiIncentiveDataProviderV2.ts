...
export declare namespace IUiIncentiveDataProviderV2 {
    ...
    export type UserIncentiveDataStruct = {tokenincentivesUserIndex: BigNumberish, userUnclaimedRewards: BigNumberish, tokenAddress: AddressLike, rewardTokenAddress: AddressLike, incentiveControllerAddress: AddressLike, rewardTokenDecimals: BigNumberish}

    export type UserIncentiveDataStructOutput = [tokenincentivesUserIndex: bigint, userUnclaimedRewards: bigint, tokenAddress: string, rewardTokenAddress: string, incentiveControllerAddress: string, rewardTokenDecimals: bigint] & {tokenincentivesUserIndex: bigint, userUnclaimedRewards: bigint, tokenAddress: string, rewardTokenAddress: string, incentiveControllerAddress: string, rewardTokenDecimals: bigint }
  

    export type UserReserveIncentiveDataStruct = {underlyingAsset: AddressLike, aTokenIncentivesUserData: IUiIncentiveDataProviderV2.UserIncentiveDataStruct, vTokenIncentivesUserData: IUiIncentiveDataProviderV2.UserIncentiveDataStruct, sTokenIncentivesUserData: IUiIncentiveDataProviderV2.UserIncentiveDataStruct}

    export type UserReserveIncentiveDataStructOutput = [underlyingAsset: string, aTokenIncentivesUserData: IUiIncentiveDataProviderV2.UserIncentiveDataStructOutput, vTokenIncentivesUserData: IUiIncentiveDataProviderV2.UserIncentiveDataStructOutput, sTokenIncentivesUserData: IUiIncentiveDataProviderV2.UserIncentiveDataStructOutput] & {underlyingAsset: string, aTokenIncentivesUserData: IUiIncentiveDataProviderV2.UserIncentiveDataStructOutput, vTokenIncentivesUserData: IUiIncentiveDataProviderV2.UserIncentiveDataStructOutput, sTokenIncentivesUserData: IUiIncentiveDataProviderV2.UserIncentiveDataStructOutput }
  
    }

  export interface IUiIncentiveDataProviderV2Interface extends Interface {
...
decodeFunctionResult(functionFragment: 'getUserReservesIncentivesData', data: BytesLike): Result;
  ...
  export interface IUiIncentiveDataProviderV2 extends BaseContract {
    ...
    connect(runner?: ContractRunner | null): IUiIncentiveDataProviderV2;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    getFullReservesIncentiveData: TypedContractMethod<
      ...
      [[IUiIncentiveDataProviderV2.AggregatedReserveIncentiveDataStructOutput[], IUiIncentiveDataProviderV2.UserReserveIncentiveDataStructOutput[]]],
      'view'
    >
