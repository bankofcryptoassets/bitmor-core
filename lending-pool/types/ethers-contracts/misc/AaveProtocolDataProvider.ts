...
export declare namespace AaveProtocolDataProvider {
    ...
    export type TokenDataStructOutput = [symbol: string, tokenAddress: string] & {symbol: string, tokenAddress: string }
  
    }

  export interface AaveProtocolDataProviderInterface extends Interface {
    getFunction(nameOrSignature: "ADDRESSES_PROVIDER" | "getAllATokens" | "getAllReservesTokens" | "getReserveConfigurationData" | "getReserveData" | "getReserveTokensAddresses" | "getUserReserveData"): FunctionFragment;
...
encodeFunctionData(functionFragment: 'getReserveConfigurationData', values: [AddressLike]): string;
...
encodeFunctionData(functionFragment: 'getUserReserveData', values: [AddressLike, AddressLike]): string;
...
decodeFunctionResult(functionFragment: 'getUserReserveData', data: BytesLike): Result;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    getReserveConfigurationData: TypedContractMethod<
      [asset: AddressLike, ],
      [[bigint, bigint, bigint, bigint, bigint, boolean, boolean, boolean, boolean, boolean] & {decimals: bigint, ltv: bigint, liquidationThreshold: bigint, liquidationBonus: bigint, reserveFactor: bigint, usageAsCollateralEnabled: boolean, borrowingEnabled: boolean, stableBorrowRateEnabled: boolean, isActive: boolean, isFrozen: boolean }],
      'view'
    >
    ...
    getUserReserveData: TypedContractMethod<
      ...
      [[bigint, bigint, bigint, bigint, bigint, bigint, bigint, bigint, boolean] & {currentATokenBalance: bigint, currentStableDebt: bigint, currentVariableDebt: bigint, principalStableDebt: bigint, scaledVariableDebt: bigint, stableBorrowRate: bigint, liquidityRate: bigint, stableRateLastUpdated: bigint, usageAsCollateralEnabled: boolean }],
      'view'
    >
    ...
    getFunction(nameOrSignature: 'ADDRESSES_PROVIDER'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'getAllATokens'): TypedContractMethod<
      [],
      [AaveProtocolDataProvider.TokenDataStructOutput[]],
      'view'
    >;
getFunction(nameOrSignature: 'getAllReservesTokens'): TypedContractMethod<
      [],
      [AaveProtocolDataProvider.TokenDataStructOutput[]],
      'view'
    >;
getFunction(nameOrSignature: 'getReserveConfigurationData'): TypedContractMethod<
      [asset: AddressLike, ],
      [[bigint, bigint, bigint, bigint, bigint, boolean, boolean, boolean, boolean, boolean] & {decimals: bigint, ltv: bigint, liquidationThreshold: bigint, liquidationBonus: bigint, reserveFactor: bigint, usageAsCollateralEnabled: boolean, borrowingEnabled: boolean, stableBorrowRateEnabled: boolean, isActive: boolean, isFrozen: boolean }],
      'view'
    >;
...
getFunction(nameOrSignature: 'getReserveTokensAddresses'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'getUserReserveData'): TypedContractMethod<
      [asset: AddressLike, user: AddressLike, ],
      [[bigint, bigint, bigint, bigint, bigint, bigint, bigint, bigint, boolean] & {currentATokenBalance: bigint, currentStableDebt: bigint, currentVariableDebt: bigint, principalStableDebt: bigint, scaledVariableDebt: bigint, stableBorrowRate: bigint, liquidityRate: bigint, stableRateLastUpdated: bigint, usageAsCollateralEnabled: boolean }],
      'view'
    >;
