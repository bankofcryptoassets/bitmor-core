...
interface ILendingPoolAddressesProviderInterface
  ...
  functions: {
    ...
    "getBitmorLoan()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getBitmorLoan",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setBitmorLoan",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "BitmorLoanUpdated(address)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "BitmorLoanUpdated"): EventFragment;
...
export class ILendingPoolAddressesProvider extends Contract {
  ...
  functions: {
    ...
    getBitmorLoan(overrides?: CallOverrides): Promise<{
      0: string;
    }>;
  ...
  getBitmorLoan(overrides?: CallOverrides): Promise<string>;
  ...
  callStatic: {
    ...
    setBitmorLoan(bitmorLoan: string, overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    BitmorLoanUpdated(bitmorLoan: string | null): EventFilter;
  ...
  estimateGas: {
    ...
    getBitmorLoan(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    getBitmorLoan(overrides?: CallOverrides): Promise<PopulatedTransaction>;
