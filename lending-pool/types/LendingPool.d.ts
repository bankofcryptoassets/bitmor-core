...
interface LendingPoolInterface extends ethers.utils.Interface {
  ...
  events: {
    ...
    "LoanAddressUpdated(address)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "LoanAddressUpdated"): EventFragment;
...
export class LendingPool extends Contract {
  ...
  filters: {
    ...
    LoanAddressUpdated(newLoanAddress: string | null): EventFilter;
